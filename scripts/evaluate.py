import os
import sys
import psycopg2  # Used to connect to postgres db
...
def main():
    ...
    for message, file in rows:
        data["question"].append('What issues exists in this code?')
    ...
    if faithfulness_score < 0.7:
        print("Faithfulness score: {faithfulness_score:.4f} is below threshold 0.7")
        sys.exit(1)
