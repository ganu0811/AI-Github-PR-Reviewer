...
async def analyze(request: AnalyzeRequest):
    ...
    '''Whatever findings we have extracted which is currently in findings_data variable, those findings will be stored in the database, that's why we are connecting to our database'''
    async with AsyncSessionLocal() as session:
    ...
    async with httpx.AsyncClient() as client:
        await client.post(
            "http://reviewer:8000/post-review",   # calling reviewer service
            json = {
