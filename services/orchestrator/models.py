...
from sqlaclemy.dialects.postgresql import UUID 
...
'''these tables have already been defined in the alembic
We are defining them again here just so to get the python representation of the tables'''
...
'''Analyze Request is not a db table. It will be used to validate API input.'''
